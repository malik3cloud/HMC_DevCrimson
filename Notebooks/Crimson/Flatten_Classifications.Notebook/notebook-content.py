...
# SQL query
df  = spark.sql("""
SELECT DISTINCT f.FundClassificationId
...
#spark.sql("Create table lh_curated.Silver.ClassificationFlattened(FundClassificationId INTEGER,AssetClass VARCHAR(5000),Strategy VARCHAR(5000),SubStrategy VARCHAR(5000)) ")
#spark.sql("delete from  lh_curated.Silver.ClassificationFlattened")
