...
#display(df)
#spark.sql("delete from lh_curated.Silver.FundPerformance")
# df = spark.sql("select FundPerformanceId,FundId,ClassificationId,AsOfDate,NAVDate,MarketValueLocal as MarketValueLocal,MarketValueUSD,LastValuationAmountLocal,LastValuationAmountUSD,LastValuationDate,LastValuationNAVDate,PercentOfGIA from lh_curated.Silver.tempFundPerformance")
...
#spark.sql("Insert into Silver.FundPerformance(FundPerformanceId,FundId,ClassificationId,AsOfDate,NAVDate,MarketValueLocal,MarketValueUSD,LastValuationAmountLocal,LastValuationAmountUSD,LastValuationDate,LastValuationNAVDate,PercentOfGIA) select FundPerformanceId,FundId,ClassificationId,AsOfDate,NAVDate,MarketValueLocal,MarketValueUSD,LastValuationAmountLocal,LastValuationAmountUSD,LastValuationDate,LastValuationNAVDate,PercentOfGIA from Silver.tempFundPerformance")
