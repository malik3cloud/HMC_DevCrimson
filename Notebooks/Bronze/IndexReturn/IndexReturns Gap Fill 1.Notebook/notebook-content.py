...
#one dummy index with a two day gap... these two dates are intentionally non-chronicalogical
  (
...
#another dummy index with a 4 day gap
    (
    "another index ID",
    8, 
    "2024-12-10",
...
columns = ["IndexId", "FrequencyId", "AsOfDate", "CurrencyId", "IndexLevel", "IndexReturn"]
df_stage = spark.createDataFrame(data, columns)
df_stage.show(10)

#df.write.mode("append").saveAsTable("STAGE_IndexReturnBloomberg")
